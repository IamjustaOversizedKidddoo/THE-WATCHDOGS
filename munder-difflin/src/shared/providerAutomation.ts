...
const CONTEXT_COMMANDS: Record<AgentProvider, ProviderContextCommands> = {
  ...
  strix: NO_CONTEXT_COMMANDS,
  shannon: NO_CONTEXT_COMMANDS,
  hackergpt: NO_CONTEXT_COMMANDS,
  hackbot: NO_CONTEXT_COMMANDS,
  hexstrike: NO_CONTEXT_COMMANDS,
  'watchdogs-cli': NO_CONTEXT_COMMANDS,
