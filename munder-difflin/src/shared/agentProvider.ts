...
export const AGENT_PROVIDER_PRESETS: AgentProviderPreset[] = [
  ...
  },
  {
    id: 'strix',
    label: 'Chris · Strix',
    defaultCommand: 'python -m uv run --project "d:\\THE WATCH DOGS\\chris" strix',
    commandGroups: [],
    autoModeFlag: '',
    supportsModel: true,
    autoFlag: '',
  ...
  {
    id: 'shannon',
    label: 'Daniel · Shannon',
    defaultCommand: 'node "d:\\THE WATCH DOGS\\daniel\\shannon"',
    commandGroups: [],
    autoModeFlag: '',
    supportsModel: false,
    autoFlag: '',
  ...
  {
    id: 'hackergpt',
    label: 'Jonathan · HackerGPT',
    defaultCommand: 'npm run dev --prefix "d:\\THE WATCH DOGS\\jonathan"',
    commandGroups: [],
    autoModeFlag: '',
    supportsModel: false,
    autoFlag: '',
  ...
  },
  {
    id: 'hackbot',
    label: 'David · HackBot',
    defaultCommand: 'python -m uv run --project "d:\\THE WATCH DOGS\\david" hackbot',
    commandGroups: [],
    autoModeFlag: '',
    supportsModel: false,
    autoFlag: '',
  ...
  {
    id: 'hexstrike',
    label: 'Tool Floor · HexStrike AI',
    defaultCommand: 'python "d:\\THE WATCH DOGS\\wrench\\hexstrike_server.py"',
    commandGroups: [],
    autoModeFlag: '',
    supportsModel: false,
    autoFlag: '',
