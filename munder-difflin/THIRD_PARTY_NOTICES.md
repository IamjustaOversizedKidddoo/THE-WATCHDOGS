...
- **License Terms** (from `src/renderer/src/assets/tilesets/LIMEZUASSETS-LICENSE.txt`):
...
- `src/renderer/src/assets/tilesets/a5-office-floors-walls.png`
- `src/renderer/src/assets/maps/office.tmj`
- `src/renderer/src/assets/maps/brooklyn99.tmj`

See [`LICENSE-ASSETS`](./LICENSE-ASSETS) and [`src/renderer/src/assets/ATTRIBUTION.md`](./src/renderer/src/assets/ATTRIBUTION.md) for further details.

### Procedural Cast Sprites
The character card portraits and walking sprites on the office floor are **not** LimeZu assets; they are drawn procedurally in [`src/renderer/src/scene/office/portraitArt.ts`](./src/renderer/src/scene/office/portraitArt.ts) from per-character recipes and are licensed under the MIT License along with the project source code.
...
All original application harness source code in this repository is licensed under the **MIT License**.

See the [`LICENSE`](./LICENSE) file in the repository root for the full text of the MIT License:
```
